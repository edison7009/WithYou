  ...
  return (
    <main className="wy-page">
      <section className="wy-hero" id="meadow" aria-labelledby="welcome-title">
        <Image className="wy-landscape" src="/images/coastal-meadow-v2.png" alt="草坡上的伙伴穿着不同颜色的夏日衣服，或坐或躺，一起面朝大海。" width={1672} height={941} priority unoptimized />
        ...
        <div className="wy-introduction">
          ...
          <div className="wy-downloads" aria-label="客户端下载">
            <button className="wy-download" disabled aria-label="下载 Windows，即将开放">
              ...
              <span>Windows<small>即将开放</small></span>
            </button>
            <button className="wy-download" disabled aria-label="下载 macOS，即将开放"><Apple aria-hidden="true" /><span>macOS<small>即将开放</small></span></button>
            <button className="wy-download" disabled aria-label="下载 Linux，即将开放"><Terminal aria-hidden="true" /><span>Linux<small>即将开放</small></span></button>
          </div>
        </div>
      </section>
    </main>
